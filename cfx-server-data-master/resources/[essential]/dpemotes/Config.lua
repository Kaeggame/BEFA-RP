...
Config.Languages = {
  ['en'] = {
        ['emotes'] = 'Emotes',
        ['danceemotes'] = "Danses",
        ['propemotes'] = "Emotes avec objets",
        ['favoriteemotes'] = "🌟 Favoris 🌟",
        ['favoriteinfo'] = "Définir un emote comme favorite",
        ['rfavorite'] = "Réinitialiser les favoris",
        ['prop2info'] = "Les emotes avec objet peuvent être situées à la fin",
        ['set'] = "Set (",
        ...
        ['cancelemote'] = "Annuler l'emote",
        ['cancelemoteinfo'] = "~r~X~w~ Annuler l'emote en cours de lecture",
