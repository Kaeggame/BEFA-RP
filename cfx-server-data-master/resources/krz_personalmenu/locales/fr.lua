Locales['fr'] = {
	...
	['animation_pegi_hsuck'] = 'Se faire suc** en voiture',
	['animation_pegi_fsuck'] = 'Suc** en voiture',
	['animation_pegi_hfuck'] = 'Bais** en voiture (Homme)',
	['animation_pegi_ffuck'] = 'Bais** en voiture (Femme)',
