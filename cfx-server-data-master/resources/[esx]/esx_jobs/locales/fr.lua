Locales['fr'] = {
  ...
  ['caution_afford']            = 'Vous ne pouvez pas vous payer la caution de ~g~$%s~s~',
  ...
  ['spawn_veh']                 = 'Sortir un véhicule de fonction',
  ...
  ['return_vh']                 = 'Rangement du véhicule véhicule',
  ...
  ['fm_spawnboat']              = 'Appuyez sur ~INPUT_PICKUP~ pour prendre un bateau.',
  ['fm_boat_title']             = 'Bâteau',
  ['fm_boat_return_title']      = 'Rangement du bateau',
  ['fm_boat_return_button']     = 'Appuyez sur ~INPUT_PICKUP~ pour ranger le bateau.',
  ...
  ['m_rock']                    = 'Pierre',
  ['m_pickrocks']               = 'Appuyez sur ~INPUT_PICKUP~ pour récupérer des pierres.',
  ['m_washrock']                = 'Pierre lavé',
  ['m_rock_button']             = 'Appuyez sur ~INPUT_PICKUP~ pour laver les pierres.',
  ...
  ['m_melt_button']             = 'Appuyez sur ~INPUT_PICKUP~ pour fondre les pierres.',
