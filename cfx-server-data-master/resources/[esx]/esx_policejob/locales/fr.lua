Locales['fr'] = {
  ...
  ['get_weapon_menu'] = 'Armurerie - retirer une arme',
  ['put_weapon_menu'] = 'Armurerie - stocker une arme',
  -- Vehicles
  ['vehicle_menu'] = 'Véhicule',
  ['vehicle_blocked'] = 'Tous les accès sont bloqués!',
  ...
  ['garage_empty'] = 'Nous n\'avez aucun véhicule dans le garage.',
  ...
  ['garage_notauthorized'] = 'Vous n\'avez pas le droit d\'acheter ce véhicule !',
  ...
  -- Vehicle interaction
  ['vehicle_info'] = 'Infos sur le véhicule',
  ...
  ['impound_canceled'] = 'Vous avez ~r~annulé~s~ la saisie',
  ['impound_canceled_moved'] = 'La saisie a été ~r~annulée~s~ parce que le véhicule a déménagé',
